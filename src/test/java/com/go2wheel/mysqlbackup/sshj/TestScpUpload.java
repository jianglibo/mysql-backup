...
//        sshSession.useCompression();
//        sshSession.newSCPFileTransfer().upload(new FileSystemFile(p.toFile()), "/tmp/");
//        RemoteCommandResult<List<String>> er = new ExecutableRunnerSshBase(sshSession, demoBox) {
//			@Override
