...
(
  ...
  created_at TIMESTAMP(2),
  CONSTRAINT fk_subscribe_grp_id FOREIGN KEY (server_grp_id)  REFERENCES server_grp (id),
  CONSTRAINT fk_subscribe_user_id FOREIGN KEY (user_account_id)  REFERENCES user_account (id),
  CONSTRAINT unique_subscribe UNIQUE (user_account_id, server_grp_id)
);
...
CREATE INDEX serverstate_created_at_idx ON server_state(created_at);
CREATE INDEX storagestate_created_at_idx ON storage_state(created_at);